"""Тест kr/claude-sonnet-4.5 модели."""
import sys
...
def main():
    ...
    print("\n=== Тест kr/claude-sonnet-4.5 ===")
    test_claude = """curl -s -X POST http://127.0.0.1:20128/v1/chat/completions \\
  -H 'Content-Type: application/json' \\
  -H 'Authorization: Bearer omni' \\
  -d '{
    "model": "kr/claude-sonnet-4.5",
    "messages": [{"role": "user", "content": "Say hello in Russian and tell me you are Claude Sonnet 4.5 from Kiro"}],
    "max_tokens": 100
  }'"""
    run(ssh, test_claude)
